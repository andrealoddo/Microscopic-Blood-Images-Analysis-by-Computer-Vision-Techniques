...
\begin{figure}[!b]
	\centering
	\includegraphics[height=0.10\textheight, width=0.10\textheight]{images/2015_1_caip/3-1}
	\includegraphics[height=0.10\textheight, width=0.10\textheight]{images/2015_1_caip/3-2}
	\includegraphics[height=0.10\textheight, width=0.10\textheight]{images/2015_1_caip/3-3}
	\includegraphics[height=0.10\textheight, width=0.10\textheight]{images/2015_1_caip/1-1}
	\includegraphics[height=0.10\textheight, width=0.10\textheight]{images/2015_1_caip/1-2}
...
A further problem in peripheral blood cells image analysis is certainly the presence of adjacent cells or, even worse, cells grouped or clumped together, like the typical leukocyte agglomerates. Cells clumps can be wrongly identified, by segmentation strategies, as single cells and then misclassified, considering that all the shape descriptors belonging to this regions will be misleading. All considered, this phase, after a proper and robust segmentation, becomes crucial to detect and separate leukocyte agglomerates. Finally, the single leukocytes can be decomposed and segmented into their components that are nucleus and cytoplasm. This process can be summarised in the following basic steps:
\begin{itemize}
