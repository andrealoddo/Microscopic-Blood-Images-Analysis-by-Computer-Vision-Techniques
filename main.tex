...
\coordinator{Prof. Michele Marchesi \\ Prof. Michel Kocher}
...
\begin{figure*}[!htbp]
	...
	\caption{\label{fig:dataset3} Original and segmented images from ALL-IDB1, IUMS-IDB, SMC-IDB and related SVM performances.}
\end{figure*}
